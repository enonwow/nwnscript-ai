...
void InitializePlayerData (object oPlayer, string sTableName)
{
    ...
    string sQuery = "INSERT INTO " + sTableName + "(name, effects, " +
        "pcplayerwinhv, pcplayerwinx, pcplayerwiny, pcoptionwinx, pcoptionwiny, " +
        "pccreditwinx, pccreditwiny, pcbugwinx, pcbugwiny, pcdescwinx, pcdescwiny, " +
        "pcdicewinx, pcdicewiny, publiccdkey, lastipaddress, creationdate) " +
        "VALUES (@name, @effects, @pcplayerwinhv, @pcplayerwinx, @pcplayerwiny, " +
        "@pcoptionwinx, @pcoptionwiny, @pccreditwinx, @pccreditwiny, @pcbugwinx, " +
    ...
    SqlBindFloat (sql, "@pcoptionwinx", -1.0f);
    SqlBindFloat (sql, "@pcoptionwiny", 0.0f);
    SqlBindFloat (sql, "@pccreditwinx", -1.0f);
    SqlBindFloat (sql, "@pccreditwiny", 0.0f);
